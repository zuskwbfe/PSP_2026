...
2. [Ключевые компоненты](#ключевые-компоненты)
   - [SPA-роутер — main.js](#1-spa-роутер--mainjs)
   - [Класс Ajax — modules/ajax.js](#2-класс-ajax--modulesajaxjs)
   - [URL-адреса API — modules/stockUrls.js](#3-url-адреса-api--modulesstockurlsjs)
   - [Главная страница — pages/mainPage.js](#4-главная-страница--pagesmainpagejs)
   - [Страница карточки — pages/cardPage.js](#5-страница-карточки--pagescardpagejs)
   - [Страница редактирования — pages/editPage.js](#6-страница-редактирования--pageseditpagejs)
   - [Компонент карточки — components/ProductCardComponent.js](#7-компонент-карточки--componentsproductcardcomponentjs)
3. [Проблема CORS и её решение](#проблема-cors-и-её-решение)
4. [Демонстрация работы](#демонстрация-работы)
5. [Инструкция по запуску](#инструкция-по-запуску)
6. [Сравнение коллбеков и промисов](#сравнение-коллбеков-и-промисов)
